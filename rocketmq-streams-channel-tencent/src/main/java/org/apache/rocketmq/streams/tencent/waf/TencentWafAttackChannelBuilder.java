...
@ServiceName(value = TencentWafAttackChannelBuilder.TYPE, aliasName = "TencentWafAttackSource")
public class TencentWafAttackChannelBuilder extends AbstractSupportShuffleChannelBuilder {
    public static final String TYPE = "tencent_waf_attack";

    @Override
    public ISource<?> createSource(String namespace, String name, Properties properties, MetaData metaData) {
        return (TencentWafAttackSource) ConfigurableUtil.create(TencentWafAttackSource.class.getName(), namespace, name, createFormatProperty(properties), null);
    }
    ...
    protected JSONObject createFormatProperty(Properties properties) {
        ...
        IChannelBuilder.formatPropertiesName(formatProperties, properties, "domain", "domain");
        IChannelBuilder.formatPropertiesName(formatProperties, properties, "queryString", "queryString");
        IChannelBuilder.formatPropertiesName(formatProperties, properties, "sort", "sort");
