        ...
        try {
            ...
            if (rule.getRuleStatus().intValue() == 3) {
                try {
                    ...
                    LOGGER.error("DefaultRuleEngine fire atciton error: ruleName is" + rule.getName(), e);
                }
            } else {
            ...
            LOGGER.error("DefaultRuleEngine fireAction error: ruleName is" + rule.getName(), e);
        }
