...
public class CaseWhenBuilder {
     ...
     */
    public static List<IScriptExpression> groupGroupScriptExpression(String namespace, String name,
        List<IScriptExpression> expressions) {
        List<IScriptExpression> scriptExpressions = new ArrayList<>();
    ...
    protected static SingleCaseWhenExpression registeSingleCaseWhen(String namespace, String name,
        GroupScriptExpression groupScriptExpression, Map<String, List<String>> map) {
     ...
     * @return
     */
    private static List<IScriptExpression> findAfterExpression(GroupScriptExpression expression,
        List<IScriptExpression> expressions, int index, Set<Integer> skiptIndexs) {
