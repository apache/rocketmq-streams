...
public class DBSink extends AbstractSink {
    protected static final Log LOG = LogFactory.getLog(DBSink.class);
        ...
        try {
            ...
            sqlCache = new MessageCache<>(new IMessageFlushCallBack<String>() {
                ...
                public boolean flushMessage(List<String> sqls) {
                    ...
                    try {
                        LOG.info(getConfigureName()+" DBSink execute sqls "+sqls.size());
            ...
            ((MessageCache<String>)sqlCache).setAutoFlushTimeGap(3000);
