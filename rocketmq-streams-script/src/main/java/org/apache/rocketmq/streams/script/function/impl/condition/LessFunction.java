...
public class LessFunction {
    ...
    @Deprecated
    @FunctionMethod(value = "lt", comment = "建议用less或<")
    public boolean lt(IMessage message, FunctionContext context, String fieldName, String value) {
    ...
    @Deprecated
    @FunctionMethod(value = "ltByField", comment = "建议用less或<")
    public boolean ltByField(IMessage message, FunctionContext context, String fieldName, String otherFieldName) {
