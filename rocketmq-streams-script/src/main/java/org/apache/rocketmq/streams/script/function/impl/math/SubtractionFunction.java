...
public class SubtractionFunction {
     ...
     * @return
     */
    @FunctionMethod(value = "subtraction", alias = "subtraction", comment = "两个数值的减法返回结果")
    public Object subtraction(IMessage message, FunctionContext context,
