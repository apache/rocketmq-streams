...
public class GreaterFunction {
    ...
    @Deprecated
    public boolean gt(IMessage message, FunctionContext context, String fieldName, String value) {
    ...
    @Deprecated
    public boolean gtByField(IMessage message, FunctionContext context, String fieldName, String otherFieldName) {
