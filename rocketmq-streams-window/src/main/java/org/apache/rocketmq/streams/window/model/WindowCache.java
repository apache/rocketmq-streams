...
public abstract class WindowCache extends
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(WindowCache.class);
    ...
    public void initMiniBatch() {
        shuffleMsgCache = new MiniBatchMsgCache(new MultiMsgMergerAndCompressFlushCallBack(), shuffleChannel.getWindow(), shuffleChannel.getWindow());
