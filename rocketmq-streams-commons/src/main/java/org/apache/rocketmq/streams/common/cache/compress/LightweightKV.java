 ...
 */
public abstract class LightweightKV<T> implements ICacheKV<T> {
    /**
    ...
    /**
     * 每一个元素分26个字节部分(下一个地址5个字节，key的md5值16个字节，int的值5个字节)
     */
    protected byte[] map;
    ...
    private LightweightKV(int capacity, int elementSize) {
    ...
    public LightweightKV(int capacity) {
        this(capacity, 26);
    }
