...
@Deprecated
public class SQLChainStage<T extends IMessage> extends AbstractStatelessChainStage<T> implements IAfterConfiguableRefreshListerner {
    protected String dbChannelName;
    ...
    protected transient IStageHandle handle = new IStageHandle() {
        ...
        public String getName() {
            return SQLChainStage.class.getName();
        }
    };

    @Override
    public void doProcessAfterRefreshConfigurable(IConfigurableService configurableService) {
        IChannel channel = configurableService.queryConfigurable(IChannel.TYPE, dbChannelName);
    ...
    public String getDbChannelName() {
        return dbChannelName;
    }

    public void setDbChannelName(String dbChannelName) {
        this.dbChannelName = dbChannelName;
    }
    ...
    public void setChannel(IChannel channel) {
        this.channel = channel;
        this.dbChannelName = channel.getConfigureName();
