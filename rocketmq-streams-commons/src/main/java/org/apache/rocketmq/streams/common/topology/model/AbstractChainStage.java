 ...
 * 流拓扑结构的一个节点
 */
public abstract class AbstractChainStage<T extends IMessage> extends AbstractStage<T> {
     ...
     * @param pipelines
     */
    public void sendSystem(IMessage message, AbstractContext context, AbstractPipeline... pipelines) {
