...
public class DynamicSplit extends BasedConfigurable implements ISplit<DynamicSplit, String> {
    ...
    @Override public int compareTo(DynamicSplit o) {
        return getQueueId().compareTo(o.getQueueId());
    }
