...
public class CommonSplit extends BasedConfigurable implements ISplit<CommonSplit, String> {
    protected String splitId;

    public CommonSplit() {
    }

    public CommonSplit(String splitId) {
    ...
    @Override public int compareTo(CommonSplit o) {
