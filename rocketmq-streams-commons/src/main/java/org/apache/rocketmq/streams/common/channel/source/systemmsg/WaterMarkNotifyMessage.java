...
public class WaterMarkNotifyMessage implements ISystemMessage {
    protected String sourceSplitId;

    public String getSourceSplitId() {
        return sourceSplitId;
    }

    public void setSourceSplitId(String sourceSplitId) {
        this.sourceSplitId = sourceSplitId;
    }

    @Override public int getSystemMessageType() {
        return ISystemMessage.WATER_MARK;
    }
}
