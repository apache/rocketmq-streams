...
public class MessageTrace {
     ...
     * @return
     */
    public static MessageTrace joinMessage(IMessage message) {
        MessageHeader messageHeader = message.getHeader();
        if (messageHeader.getMessageTrace() == null) {
            messageHeader.setMessageTrace(new MessageTrace());
        }
        return messageHeader.getMessageTrace();
    }
