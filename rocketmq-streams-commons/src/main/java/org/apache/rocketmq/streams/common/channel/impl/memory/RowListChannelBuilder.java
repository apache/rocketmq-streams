...
@ServiceName(value = RowListChannelBuilder.TYPE, aliasName = "RowListSource")
public class RowListChannelBuilder extends AbstractSupportShuffleChannelBuilder {

    public static final String TYPE = "row_list";
    ...
    public ISource createSource(String namespace, String name, Properties properties, MetaData metaData) {
        return (ISource) ConfigurableUtil.create(RowListSource.class.getName(), namespace, name, createFormatProperty(properties), null);
    }
    ...
    protected JSONObject createFormatProperty(Properties properties) {
        ...
        IChannelBuilder.formatPropertiesName(formatProperties, properties, "rows", "list");
        IChannelBuilder.formatPropertiesName(formatProperties, properties, "rows", "data");
        return formatProperties;
    }

    @Override
    public ISource copy(ISource pipelineSource) {
        return new RowListSource();
    }
