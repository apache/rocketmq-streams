...
import org.apache.rocketmq.streams.state.IStreamState;
 ...
 * @author arthur.liang
 */
public class RocksdbState implements IStreamState<java.lang.String, java.lang.String> {
    ...
    @Override public String get(String key) {
        try {
            ...
            //throw new RuntimeException("failed in getting key from rocksdb! " + key, e);
            return null;
        }
    }
