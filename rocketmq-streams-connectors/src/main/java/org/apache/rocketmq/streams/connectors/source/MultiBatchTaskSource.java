...
public class MultiBatchTaskSource extends AbstractPullSource {

    @Override protected ISplitReader createSplitReader(ISplit<?, ?> split) {
        return new ISplitReader() {
            private transient ISplit<?, ?> split;
            private boolean isInterrupt;
            private boolean isClose;
            private final transient AtomicLong offsetGenerator = new AtomicLong(1000000000);
    ...
    protected static class PipelineSplit implements ISplit<PipelineSplit, ChainPipeline<?>> {
