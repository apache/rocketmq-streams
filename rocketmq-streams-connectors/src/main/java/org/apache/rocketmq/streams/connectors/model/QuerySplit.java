...
public class QuerySplit  extends BasedConfigurable implements ISplit<QuerySplit, String> {
    ...
    public QuerySplit(String queueId, Long initStartTime, long dateAdd, Long pollingMinute,int pageNum) {
    ...
    @Override
    public int compareTo(QuerySplit o) {
