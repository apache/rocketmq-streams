...
@AutoService(IChannelBuilder.class) @ServiceName(value = SlsChannelBuilder.TYPE, aliasName = "SLSSource") public class SlsChannelBuilder extends AbstractSupportShuffleChannelBuilder {
    public static final String TYPE = "sls";
    ...
    @Override public ISource createSource(String namespace, String name, Properties properties, MetaData metaData) {
        return (ISource) ConfigurableUtil.create(SLSSource.class.getName(), namespace, name, createFormatProperty(properties), null);
    }
    ...
    @Override public ISink createBySource(ISource pipelineSource) {
        SLSSource source = (SLSSource) pipelineSource;
