...
package org.apache.rocketmq.streams.db.init.mysql.delegate;
...
public class MysqlDelegate implements DBDelegate {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(MysqlDelegate.class);
    ...
    private String[] loadSqls() {
        ...
        try {
            ...
            if (LOGGER.isDebugEnabled()) {
                LOGGER.debug("Init db sqls : " + tables);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
