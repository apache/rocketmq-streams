...
public class ProcessorFactory<K, V, OK, OV> implements RealProcessorFactory<K, V, OK, OV> {
    ...
    public ProcessorFactory(String name, Supplier<? extends Processor<K, V, OK, OV>> supplier) {
        this.name = name;
